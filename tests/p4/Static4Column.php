	...
	public function testStatic4Column() {
		...
		try {
			$ta = $this->webDriver->findElement(
				By::cssSelector('li[data-shortcode="shortcake_static_four_column"]')
			);
			$ta -> click();
		} catch(Exception $e) {
		...
		try{
			$this->webDriver->findElement(By::id('attachment_1'));
			$this->webDriver->findElement(By::name('title_1'));
			$this->webDriver->findElement(By::name('description_1'));
			$this->webDriver->findElement(By::name('link_text_1'));
			$this->webDriver->findElement(By::name('link_url_1'));
			$this->webDriver->findElement(By::id('attachment_2'));
			$this->webDriver->findElement(By::name('link_url_2'));
			$this->webDriver->findElement(By::name('link_text_2'));
			$this->webDriver->findElement(By::name('description_2'));
			$this->webDriver->findElement(By::name('title_2'));
			$this->webDriver->findElement(By::id('attachment_3'));
			$this->webDriver->findElement(By::name('title_3'));
			$this->webDriver->findElement(By::name('description_3'));
			$this->webDriver->findElement(By::name('link_text_3'));
			$this->webDriver->findElement(By::name('link_url_3'));
			$this->webDriver->findElement(By::id('attachment_4'));
			$this->webDriver->findElement(By::name('title_4'));
			$this->webDriver->findElement(By::name('description_4'));
			$this->webDriver->findElement(By::name('link_text_4'));
			$this->webDriver->findElement(By::name('link_url_4'));
		}catch(Exception $e){
		...
		$this->webDriver->findElement(By::id('attachment_1'))->click();
		$this->webDriver->findElement(By::linkText('Media Library'))->click();
		...
		$this->webDriver->findElement(By::name('title_1'))->click();
		$this->webDriver->getKeyboard()->sendKeys($title1);
		$this->webDriver->findElement(By::name('description_1'))->click();
		$this->webDriver->getKeyboard()->sendKeys($description1);
		$this->webDriver->findElement(By::name('link_text_1'))->click();
		$this->webDriver->getKeyboard()->sendKeys($linktext1);
		$this->webDriver->findElement(By::name('link_url_1'))->click();
		...
		// Fill in rest of fields
		$this->webDriver->findElement(By::name('title_2'))->click();
		$this->webDriver->getKeyboard()->sendKeys($title2);
		$this->webDriver->findElement(By::name('description_2'))->click();
		$this->webDriver->getKeyboard()->sendKeys($description2);
		$this->webDriver->findElement(By::name('link_text_2'))->click();
		$this->webDriver->getKeyboard()->sendKeys($linktext2);
		$this->webDriver->findElement(By::name('link_url_2'))->click();
		...
		// Fill in rest of fields
		$this->webDriver->findElement(By::name('title_3'))->click();
		$this->webDriver->getKeyboard()->sendKeys($title3);
		$this->webDriver->findElement(By::name('description_3'))->click();
		$this->webDriver->getKeyboard()->sendKeys($description3);
		$this->webDriver->findElement(By::name('link_text_3'))->click();
		$this->webDriver->getKeyboard()->sendKeys($linktext3);
		$this->webDriver->findElement(By::name('link_url_3'))->click();
		...
		// Fill in rest of fields
		$this->webDriver->findElement(By::name('title_4'))->click();
		$this->webDriver->getKeyboard()->sendKeys($title4);
		$this->webDriver->findElement(By::name('description_4'))->click();
		$this->webDriver->getKeyboard()->sendKeys($description4);
		$this->webDriver->findElement(By::name('link_text_4'))->click();
		$this->webDriver->getKeyboard()->sendKeys($linktext4);
		$this->webDriver->findElement(By::name('link_url_4'))->click();
		...
		$this->webDriver->findElement(By::id('content-html'))->click();
		$this->webDriver->findElement(By::id('content'))->click();
		$this->webDriver->action()->keyDown(null, WebDriverKeys::CONTROL)->perform();
		$this->webDriver->getKeyboard()->pressKey(WebDriverKeys::END);
