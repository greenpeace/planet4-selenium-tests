...
class P4_Jetpack extends P4_login {
  ...
  public function testJetpack()
  {
	...
	$field->click();
	$this->webDriver->getKeyboard()->sendKeys('Test automated - Jetpack');
	...
	try{
		$cartomap = $this->webDriver->findElement(
			WebDriverBy::cssSelector('.post-details iframe'))->getAttribute('src');
	}catch(Exception $e){
		$this->fail("->Some of the content created is not displayed in front end page");
	}
	$this->assertEquals("$cartomaplink","$cartomap");
