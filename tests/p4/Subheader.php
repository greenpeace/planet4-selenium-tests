...
class P4_Subheader extends P4_login {
  ...
  public function testSubheader()
  {
	...
	$field->click();
	$this->webDriver->getKeyboard()->sendKeys('Subheader Block Test');
	
	$field = $this->webDriver->findElement(
	WebDriverBy::name('description')
	);
	$field->click();
	$this->webDriver->getKeyboard()->sendKeys('This is content created by an automated test for testing subheader block');
